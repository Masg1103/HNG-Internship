...
-- Update Part table to correct the association for Job ID 3
UPDATE PartDim
SET JobID = 3
...
SELECT SUM(SalesTax) AS TotalSalesTax, SUM(Total) AS TotalRevenue, (SUM(SalesTax) / SUM(Total)) * 100 AS SalesTaxPercentage
FROM InvoiceDim;
